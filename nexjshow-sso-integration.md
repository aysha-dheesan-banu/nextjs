...
**You will receive:**
- `client_id` — `client_9pSQX7CUjI_hwXJt8Wbjaw`
...
WYTPASS_CLIENT_ID=client_9pSQX7CUjI_hwXJt8Wbjaw
WYTPASS_CLIENT_SECRET=<rotate-secret-to-get-new-value>
...
```json
{
  ...
  "sub": "user-uuid",
  "aud": "client_9pSQX7CUjI_hwXJt8Wbjaw",
  "iat": 1700000000,
  "exp": 1700003600,
